...
class Person(pygame.sprite.Sprite):
    ...
    def events(self):
        ...
        if self.rect.collidepoint((mx, my)) and self.game.clickManager.getClicked():
            ...
            if (
                self.spriteRenderer.getPersonHolderClickManager().getPersonHolder() is not None 
                    and self not in self.spriteRenderer.getPersonHolderClickManager().getPersonHolder().getPeople()):
